...
{
    protected async Task<Contact?> DoLoginTestAsync(LoginModel loginModel)
    {
        ...
        if (Configuration != null)
        {
            ...
            {
                var actionAddRes = await ContactService.LoginAsync(loginModel);
                ...
                if (actionAddRes != null && actionAddRes.Result != null)
                {
                    ...
                    if (((OkObjectResult)actionAddRes.Result).Value != null)
                    {
                        ...
                        if (contactRet != null)
                        {
                            ...
                            Assert.Empty(contactRet.ResetPasswordTempCode);
                            Assert.NotEmpty(contactRet.Token);
                        }
                    }
                }
            }
