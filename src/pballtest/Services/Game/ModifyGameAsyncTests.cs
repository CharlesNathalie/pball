                ...
                if (LeagueContactService != null)
                {
                    if (contact != null && contact2 != null && contact3 != null && contact4 != null && league != null)
                    {
                        ...
                        if (GameService != null)
                        {
                            ...
                            if (gameRet != null)
                            {
                                gameRet.Team1Player1 = game.Team1Player2;
                                gameRet.Team1Player2 = game.Team1Player1;
                                gameRet.Team2Player1 = game.Team2Player2;
                                gameRet.Team2Player2 = game.Team2Player1;
                                gameRet.Team1Scores = game.Team2Scores;
                                gameRet.Team2Scores = game.Team1Scores;

                                var actionModifyRes = await GameService.ModifyGameAsync(gameRet);
    ...
    public async Task ModifyGameAsync_Autorization_Error_Test(string culture)
    {
        ...
        if (ContactService != null)
        {
            ...
            if (GameService != null)
            {
                ...
                boolRet = await DoBadRequestGameTestAsync(PBallRes.YouDoNotHaveAuthorization, actionModifyRes);
    ...
    public async Task ModifyGameAsync_GameID_Error_Test(string culture)
    {
        ...
        if (ContactService != null)
        {
            ...
            if (GameService != null)
            {
                ...
                boolRet = await DoBadRequestGameTestAsync(string.Format(PBallRes._IsRequired, "GameID"), actionModifyRes);
                Assert.NotNull(boolRet);
                Assert.True(boolRet);
                    ...
                    if (contact != null && contact2 != null && contact3 != null && contact4 != null && league != null)
                    {
                        ...
                        if (GameService != null)
                        {
                            ...
                            if (gameRet != null)
                            {
                                ...
                                gameRet.LeagueID = 10000;

                                actionModifyRes = await GameService.ModifyGameAsync(gameRet);
                                boolRet = await DoBadRequestGameTestAsync(string.Format(PBallRes._IsRequired, "LeagueID"), actionModifyRes);
                                Assert.NotNull(boolRet);
                                Assert.True(boolRet);
                            }
                ...
                if (LeagueContactService != null)
                {
                    if (contact != null && contact2 != null && contact3 != null && contact4 != null && league != null)
                    {
                        ...
                        if (GameService != null)
                        {
                            ...
                            if (gameRet != null)
                            {
                                gameRet.Team1Scores = -1;

                                var actionModifyRes = await GameService.ModifyGameAsync(gameRet);
                                boolRet = await DoBadRequestGameTestAsync(string.Format(PBallRes._MinValueIs_, "Team1Scores", "0"), actionModifyRes);
                                Assert.NotNull(boolRet);
                                Assert.True(boolRet);
                            }
                        }
                ...
                if (LeagueContactService != null)
                {
                    if (contact != null && contact2 != null && contact3 != null && contact4 != null && league != null)
                    {
                        ...
                        if (GameService != null)
                        {
                            ...
                            if (gameRet != null)
                            {
                                gameRet.Team2Scores = -1;

                                var actionModifyRes = await GameService.ModifyGameAsync(gameRet);
                                boolRet = await DoBadRequestGameTestAsync(string.Format(PBallRes._MinValueIs_, "Team2Scores", "0"), actionModifyRes);
                                Assert.NotNull(boolRet);
                                Assert.True(boolRet);
                            }
                        }
