                ...
                if (gameInDB != null)
                {
                    ...
                    if (contact != null)
                    {
                        ...
                        if (gameInDB != null)
                        {
                            ...
                            {
                                var actionGetAllRes = await GameService.GetAllLeagueGamesBetweenDatesAsync(leagueGamesModel);
                                bool? boolRet = await DoBadRequestGameListTestAsync(string.Format(PBallRes.CouldNotFind_With_Equal_, "League", "LeagueID", leagueGamesModel.LeagueID.ToString()), actionGetAllRes);
                                Assert.NotNull(boolRet);
                                Assert.True(boolRet);
                            }
                        }
