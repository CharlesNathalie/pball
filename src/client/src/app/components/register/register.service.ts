...
export class RegisterService {
  ...
  ConfirmPasswordIsRequired: string[] = ['Confirm password is required', 'La confirmation du mot de passe est requis'];
  ...
  PasswordAndConfirmPasswordAreNotIdentical: string[] = ['Password and confirm password are not identical', 'Le mot de pass et sa confirmation ne sont pas identique'];
